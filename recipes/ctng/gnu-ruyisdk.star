...
_ARTIFACT_GLOBS = {
    "amd64": [
        "RuyiSDK-*-RuyiSDK-Sources-*-riscv64-ruyisdk-linux-gnu.tar.xz",
    ],
    "arm64": [
        "RuyiSDK-*-RuyiSDK-Sources-*-HOST-aarch64-linux-gnu-riscv64-ruyisdk-linux-gnu.tar.xz",
    ],
    "riscv64": [
        "RuyiSDK-*-RuyiSDK-Sources-*-HOST-riscv64-linux-gnu-riscv64-ruyisdk-linux-gnu.tar.xz",
    ],
}


def _make_build(host):
    defconfig = "toolchain-configs/gnu-ruyisdk/host-%s.defconfig" % host
