# Build recipe for qemu/upstream @ RuyiSDK datestamp 20240128.
#
# Drives the same ruyi-build-qemu-inner entry point as the legacy
# ./ruyi-build-qemu ./qemu-configs/upstream-20240128.sh ... workflow,
...
_CONFIG = {
    ...
    "pkgversion": "RuyiSDK %s" % _RUYI_DATESTAMP,
...
RUYI.build.schedule_build(_build, name = "qemu-upstream-20240128")
